                        ...
                        <div className="Inputs grid gap-5 pt-5 pb-3">
                            <div className="row flex gap-5">
                                <div className="FirstName grid gap-1">
                                    ...
                                    <Input type="email" placeholder="Parsa" className="bg-transparent p-2 border-2 border-gray-400 rounded-2xl ml-3" />
                                </div>
                                <div className="LastName grid gap-1">
                                    <label htmlFor="lastName">
                                        LastName
                                    </label>
                                    <Input type="password" placeholder="Naderi" className="bg-transparent p-2 border-2 border-gray-400 rounded-2xl ml-3" />
                                </div>
                            </div>
                            <div className="Email grid gap-1">
                                ...
                                <Input type="email" placeholder="ParsaNaderi1387.programmer@gmail.com" className="bg-transparent p-2 border-2 border-gray-400 rounded-2xl ml-3" />
                            </div>
                            <div className="Password grid gap-1">
                                <label htmlFor="password">
                                    Password
                                </label>
                                <Input type="password" placeholder="Sudo passwd" className="bg-transparent p-2 border-2 border-gray-400 rounded-2xl ml-3" />
                            </div>
                        </div>
                        <div className="Button grid grid-cols-1 gap-2 justify-center items-center pt-5 pb-3">
                            <button className="bg-red-400 rounded-2xl text-white border-red-400  w-full py-2 px-4 transition duration-500 hover:bg-red-500">Register</button>
