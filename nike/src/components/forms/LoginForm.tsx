                ...
                <div className="Content p-8">
                    ...
                    <div className="Inputs grid gap-5 pt-5 pb-3">
                        <div className="Email grid gap-1 w-95">
                            ...
                            <Input type="email" placeholder="ParsaNaderi1387.programmer@gmail.com" className="bg-transparent p-2 border-2 border-gray-400 rounded-2xl ml-3 w-full" />
                        </div>
                        <div className="Password grid gap-1">
                            <label htmlFor="password">
                                Password
                            </label>
                            <Input type="password" placeholder="Sudo passwd" className="bg-transparent p-2 border-2 border-gray-400 rounded-2xl ml-3 w-full" />
                        </div>
                    </div>
                    <div className="Button grid grid-cols-1 gap-2 justify-center items-center pt-5 pb-3">
                        <button className="bg-red-400 rounded-2xl text-white border-red-400  w-full py-2 px-4 transition duration-500 hover:bg-red-500 ml-3">Login</button>
